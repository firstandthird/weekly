...
(function($) {
  ...
  $.declare('weekly', {
    ...
    registerClickToCreate: function() {
      ...
      gridDays.on('mouseup', this.proxy(function(){
        ...
        if(this.pendingEvent) {
          ...
          var startDate = new Date(parsedDate[0], parsedDate[1]-1, parsedDate[2], ~~eventData.starttime, this.fromDecimal(eventData.starttime));
          var endDate = new Date(parsedDate[0], parsedDate[1]-1, parsedDate[2], ~~eventData.endtime, this.fromDecimal(eventData.endtime));
          var start = this.getDateWithTimezone(startDate, this.utcOffset);
          var end = this.getDateWithTimezone(endDate, this.utcOffset);
          this.addEvent({
            start: start,
            end: end,
            startOrigin: startDate,
            endOrigin: endDate
          });
    ...
    createEvent: function(event) {
      ...
      var start = this.getDateWithTimezone(new Date(dateSplit[0], dateSplit[1]-1, dateSplit[2], startTime, this.fromDecimal(startTime)), this.utcOffset);
      var end = this.getDateWithTimezone(new Date(dateSplit[0], dateSplit[1]-1, dateSplit[2], endTime, this.fromDecimal(endTime)), this.utcOffset);
    ...
    renderEvent: function(event) {
      ...
      var start = this.getDateWithTimezone(event.start, this.utcOffset);
      var end = this.getDateWithTimezone(event.end, this.utcOffset);
    ...
    getDateWithTimezone: function(date, offset) {
      ...
      var nd = new Date(utc + (1000 * 60 * 60 * offset));
      return nd;
    },
