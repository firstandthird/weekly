...
(function($) {
  ...
  $.declare('weekly', {
    ...
    showPreviewEvent: function(event) {
      ...
      var eventDate = target.data('date');
      ...
      target.append('<div class="weekly-event-preview"><div class="weekly-event-preview-time weekly-event-time">' + start.format('h:mm') + ' - ' + end.format('h:mmA') + '</div></div>');
    ...
    modifyEvent: function(event) {
      ...
      this.events[target.data('eventIndex')].end = end;
    ...
    renderEvent: function(event) {
      var start = moment(event.start.getTime()).tz(this.timezone);
      var end = moment(event.end.getTime()).tz(this.timezone);
      ...
      var diff = end.toDate().getTime() - start.toDate().getTime();
