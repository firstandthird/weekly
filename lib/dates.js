...
(function(w){
  ...
  var dateUtils = {
    ...
    datetimeToDate: function(date, time) {
      var parsedDate = dateUtils.parseDate(date);
      var parsedTime = dateUtils.parseTime(time);

      return new Date(parsedDate.year, parsedDate.month, parsedDate.day, parsedTime.hours, parsedTime.minutes);
    },
